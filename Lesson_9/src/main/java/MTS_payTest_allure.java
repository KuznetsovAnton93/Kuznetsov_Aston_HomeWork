...
public class MTS_payTest_allure {
    ...
    @Test
    @Description("Тест проверяет форму 'Онлайн пополнение без комиссии'")
    @Epic("Оплата услуг")
    @Feature("Форма 'Онлайн пополнение без комиссии'")
    @Story("Проверка корректности работы формы оплаты с указанием вида услгу, номера телефона и суммы")
    ...
    @Test
    @Description("Тест проверяет сумму отображаемую на транице оплаты, вид услуги, номер телефон, отображения значков патежных систем и заполнение полей с данными карты")
    @Epic("Оплата услуг")
    @Feature("Форма ввода данных карты")
    @Story("Проверка валидации и корректности отображения элементов в форме для ввода данных карты")
